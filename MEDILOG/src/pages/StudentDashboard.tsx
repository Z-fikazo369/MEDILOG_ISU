...
const StudentDashboard: React.FC = () => {
  ...
  const loadUnreadCount = async () => {
    if (!user?._id) return;
    try {
      const response = await medicalAPI.getUnreadCount(user._id);
            ...
            <div className="card shadow-sm">
              ...
              <div className="card-body">
                ...
                <div className="border rounded p-3 mb-3">
                  <h4 className="mb-1">Zyril Anne Villanueva</h4>
                  <p className="text-muted mb-2">Nurse V</p>
                  <div
                ...
                {/* Staff 2 */}
                <div className="border rounded p-3 mb-3">
                  <h4 className="mb-1">Ma. Richyn Joyce Santos</h4>
                ...
                {/* Staff 3 */}
                <div className="border rounded p-3 mb-3">
                  <h4 className="mb-1">Lady Christaine Inigo</h4>
                  <p className="text-muted mb-2">Nurse IV</p>
                  <div
                    style={{ maxWidth: "350px" }}
                    className="d-flex flex-column gap-2 mt-2"
                  >
